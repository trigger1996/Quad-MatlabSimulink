...
static void initialize_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void initialize_params_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct *
  chartInstance);
static void enable_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void disable_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void c11_update_debugger_state_c11_quad_x_model
  (SFc11_quad_x_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_quad_x_model
  (SFc11_quad_x_modelInstanceStruct *chartInstance);
static void set_sim_state_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c11_st);
static void finalize_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void sf_gateway_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void mdl_start_c11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void initSimStructsc11_quad_x_model(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber, uint32_T c11_instanceNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_emlrt_marshallIn(SFc11_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c11_b_az, const char_T *c11_identifier);
static real_T c11_b_emlrt_marshallIn(SFc11_quad_x_modelInstanceStruct
...
static const mxArray *c11_b_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_c_emlrt_marshallIn(SFc11_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static uint8_T c11_d_emlrt_marshallIn(SFc11_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_quad_x_model, const char_T *
  c11_identifier);
static uint8_T c11_e_emlrt_marshallIn(SFc11_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void init_dsm_address_info(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc11_quad_x_modelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_quad_x_model = 0U;
}
  ...
  (SFc11_quad_x_modelInstanceStruct *chartInstance)
{
  ...
  c11_b_hoistedGlobal = chartInstance->c11_is_active_c11_quad_x_model;
  ...
  *chartInstance, const mxArray *c11_st)
{
  ...
  *chartInstance->c11_az = c11_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c11_is_active_c11_quad_x_model = c11_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_quad_x_model");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_quad_x_model(chartInstance);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_quad_x_modelInstanceStruct *chartInstance;
  chartInstance = (SFc11_quad_x_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c11_quad_x_model_get_eml_resolved_functions_info(void)
{
  ...
  c11_identifier)
{
  ...
  c11_y = c11_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_quad_x_model), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_quad_x_model);
  return c11_y;
}
...
void sf_c11_quad_x_model_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c11_quad_x_model_get_post_codegen_info(void);
mxArray *sf_c11_quad_x_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c11_quad_x_model_get_post_codegen_info();
...
mxArray *sf_c11_quad_x_model_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c11_quad_x_model_jit_fallback_info(void)
{
...
mxArray *sf_c11_quad_x_model_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_quad_x_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"az\",},{M[8],M[0],T\"is_active_c11_quad_x_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_quad_x_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc11_quad_x_modelInstanceStruct *)
...
static void sf_opaque_initialize_c11_quad_x_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_quad_x_modelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c11_quad_x_model(void *chartInstanceVar)
{
  enable_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_quad_x_model(void *chartInstanceVar)
{
  disable_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_quad_x_model(void *chartInstanceVar)
{
  sf_gateway_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c11_quad_x_model(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c11_quad_x_model(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c11_quad_x_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_quad_x_modelInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc11_quad_x_model((SFc11_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_quad_x_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c11_quad_x_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c11_quad_x_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_quad_x_model(SimStruct *S)
{
  SFc11_quad_x_modelInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc11_quad_x_modelInstanceStruct *)utMalloc(sizeof
    (SFc11_quad_x_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_quad_x_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c11_quad_x_model;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_quad_x_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c11_quad_x_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_quad_x_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c11_quad_x_model;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_quad_x_model;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_quad_x_model;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_quad_x_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_quad_x_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_quad_x_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c11_quad_x_model;
...
void c11_quad_x_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_quad_x_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_quad_x_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_quad_x_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_quad_x_model_method_dispatcher.\n"
