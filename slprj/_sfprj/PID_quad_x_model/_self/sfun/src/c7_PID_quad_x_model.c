...
static void initialize_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void initialize_params_c7_PID_quad_x_model
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance);
static void enable_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void disable_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_PID_quad_x_model
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_PID_quad_x_model
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance);
static void set_sim_state_c7_PID_quad_x_model
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void sf_gateway_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void mdl_start_c7_PID_quad_x_model(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void initSimStructsc7_PID_quad_x_model
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c7_b_alpha_z, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_PID_quad_x_modelInstanceStruct
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_c_emlrt_marshallIn(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_d_emlrt_marshallIn(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_PID_quad_x_model, const
  char_T *c7_identifier);
static uint8_T c7_e_emlrt_marshallIn(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_PID_quad_x_modelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_PID_quad_x_model = 0U;
}
  ...
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance)
{
  ...
  c7_b_hoistedGlobal = chartInstance->c7_is_active_c7_PID_quad_x_model;
  ...
  (SFc7_PID_quad_x_modelInstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *chartInstance->c7_alpha_z = c7_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c7_is_active_c7_PID_quad_x_model = c7_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 1)),
     "is_active_c7_PID_quad_x_model");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_PID_quad_x_model(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_PID_quad_x_modelInstanceStruct *chartInstance;
  chartInstance = (SFc7_PID_quad_x_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_PID_quad_x_model_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_PID_quad_x_model), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_PID_quad_x_model);
  return c7_y;
}
...
void sf_c7_PID_quad_x_model_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_PID_quad_x_model_get_post_codegen_info(void);
mxArray *sf_c7_PID_quad_x_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_PID_quad_x_model_get_post_codegen_info();
...
mxArray *sf_c7_PID_quad_x_model_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_PID_quad_x_model_jit_fallback_info(void)
{
...
mxArray *sf_c7_PID_quad_x_model_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_PID_quad_x_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha_z\",},{M[8],M[0],T\"is_active_c7_PID_quad_x_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_PID_quad_x_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_PID_quad_x_modelInstanceStruct *)
...
static void sf_opaque_initialize_c7_PID_quad_x_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_PID_quad_x_model(void *chartInstanceVar)
{
  enable_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_PID_quad_x_model(void *chartInstanceVar)
{
  disable_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_PID_quad_x_model(void *chartInstanceVar)
{
  sf_gateway_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_PID_quad_x_model(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_PID_quad_x_model(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_PID_quad_x_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_PID_quad_x_modelInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_PID_quad_x_model((SFc7_PID_quad_x_modelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_PID_quad_x_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_PID_quad_x_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_PID_quad_x_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_PID_quad_x_model(SimStruct *S)
{
  SFc7_PID_quad_x_modelInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_PID_quad_x_modelInstanceStruct *)utMalloc(sizeof
    (SFc7_PID_quad_x_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_PID_quad_x_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_PID_quad_x_model;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_PID_quad_x_model;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_PID_quad_x_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_PID_quad_x_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_PID_quad_x_model;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_PID_quad_x_model;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_PID_quad_x_model;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_PID_quad_x_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_PID_quad_x_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_PID_quad_x_model;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_PID_quad_x_model;
...
void c7_PID_quad_x_model_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_PID_quad_x_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_PID_quad_x_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_PID_quad_x_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_PID_quad_x_model_method_dispatcher.\n"
